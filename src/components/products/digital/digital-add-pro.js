							...
							<CardBody>
								<div className="digital-add needs-validation">
											...
											<>
												<FormGroup check>
													<Label check>
														...
														onChange={(e)=>handleCheckboxChange(e,"selectedCategory")}
												...
												<FormGroup check>
													<Label check>
														<Input
															...
															value={e?._id}
															// checked={isChecked}
															onChange={(e)=>handleCheckboxChange(e,"selectedBrand")}
														/>{' '}
														{e?.name}
													</Label>
												</FormGroup>
									...
									<FormGroup>
										...
										<textarea rows="4" name="longDescription" onChange={handleInputChange} cols="12"></textarea>
									</FormGroup>
									<FormGroup>
										<Label className="col-form-label">
